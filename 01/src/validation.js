function validation(params) {
  ...
  } else if (params.username.length < checkUsername.minLength || checkUsername.maxLength < params.username.length) {
  ...
  } else if (params.password.length < checkPassword.minLength || checkPassword.maxLength < params.password.length) {
